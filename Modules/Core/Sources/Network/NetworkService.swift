...
public protocol NetworkService<Target>: Sendable {
    ...
    func request<T: Decodable & Sendable>(_ target: Target, decodeTo type: T.Type) async throws -> T
    func requestVoid(_ target: Target) async throws
    func checkRequest<T: Decodable & Sendable>(_ target: Target, decodeTo type: T.Type) async throws -> CheckResult<T>
}
