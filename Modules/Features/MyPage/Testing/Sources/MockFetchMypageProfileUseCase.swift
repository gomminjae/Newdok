...
public final class MockFetchMypageProfileUseCase: FetchMypageProfileUseCase {
    public var result: Result<MypageUser, Error> = .success(
        MypageUser(id: 1, loginId: "test", phoneNumber: "010-0000-0000", subscribeEmail: "test@test.com", nickname: "테스트", birthYear: "2000", gender: "M", createdAt: "2025-01-01", industryId: 1, interests: [])
    )
